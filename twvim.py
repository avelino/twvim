...
def Authenticate(to):
    ...
    username = vim.eval("g:twvimuser")
    password = vim.eval("g:twvimpass")
...
def Timeline(broad):
    if broad == "friends":
        ...
        binfo = {'title':'# Your friends Twitter timeline','name':'TwvF'}
    else:
        try:
        ...
        binfo = {'title':'# Twitter public timeline', 'name': 'TwvP'}
